# SUAPC 2026 Summer final Spotboard
...
The scoreboard is served from `index.html`; its final data is stored in `data/contest.json` and `data/runs.json`.

The web application is derived from [spotboard/spotboard](https://github.com/spotboard/spotboard), whose upstream project is distributed under the MIT License. Contest data and other archive material remain subject to this repository's licensing terms.
